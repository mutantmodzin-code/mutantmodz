      ...
      <div className="max-w-[1700px] mx-auto px-6 sm:px-12">
        <div className="flex justify-between items-end mb-16 px-4">
          <div className="space-y-4">
            <div className="text-red-500 font-black tracking-[0.4em] text-[10px] uppercase">Operational Manifest: Arrival</div>
            <h2 className="text-5xl sm:text-7xl font-black text-white tracking-tighter uppercase leading-none">
              NEW <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-900">DEPLOYS</span>
            </h2>
            <p className="text-zinc-500 font-black uppercase tracking-widest text-xs max-w-sm">
              The latest performance hardware freshly added to the arsenal.
            </p>
          </div>
        ...
        <div className="flex justify-center">
          <button 
            ...
            className="group flex items-center gap-6 px-16 py-8 bg-white text-black rounded-[2rem] font-black uppercase tracking-widest text-sm hover:bg-red-600 hover:text-white transition-all transform hover:-translate-y-2 active:scale-95"
          >
            Access Entire Arrival Database <ArrowUpRight className="group-hover:-translate-y-1 group-hover:translate-x-1 transition-transform" />
          </button>
        </div>
      </div>
    </section>
