...
export default function Brands({ onNavigate }: { onNavigate: (page: string, params?: string) => void }) {
  return (
    <div className="min-h-screen bg-zinc-950 pt-44 pb-20">
      ...
      <div className="max-w-[1700px] mx-auto px-4 sm:px-12">
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-7 2xl:grid-cols-7 gap-3 sm:gap-4 animate-in fade-in slide-in-from-bottom-8 duration-700">
          {brands.map((brand, i) => (
            <button
              key={i}
